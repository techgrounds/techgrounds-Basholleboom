...
resource backupVault 'Microsoft.RecoveryServices/vaults/backupFabrics/backupProtectionIntent@2021-11-01-preview' = {
  ...
  properties: {
    itemType: 'VM'
    policyId: '/subscriptions/c4ad36f6-e6a1-405f-afd4-321e43455706/resourceGroups/${virtualMachineResourceGroup}/providers/Microsoft.Compute/virtualMachines/${virtualMachineName}/backupPolicies/default'
    sourceResourceId: '/subscriptions/c4ad36f6-e6a1-405f-afd4-321e43455706/resourceGroups/${virtualMachineResourceGroup}/providers/Microsoft.Compute/virtualMachines/${virtualMachineName}'
  }
  identity:{
    type:'SystemAssigned'
  }
